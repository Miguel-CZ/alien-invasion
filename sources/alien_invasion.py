...
class AlienInvasion:
    ...
    def _check_events(self):
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.QUIT:
                filename = 'D:/OneDrive - Universidad Politécnica de Madrid/Aa Universidad/4.1. Python/Python Crash Course/alien_invasion/scores/highscore.txt'
                with open(filename,'w') as file_object:
                    file_object.write(str(self.highscore))
                pygame.quit()
                sys.exit()
            # Key pressed
    ...
    def _update_aliens(self):
        """Update position for all aliens in the fleet."""
